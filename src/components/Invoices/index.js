  ...
  const RenderHeader = () =>{
    return(
      <div className="heading">
        <h1>Invoices</h1>
        <p className="body1 heading-sous-title">There are {currentData.length} total Invoices</p>
      </div>
    )
  }
  ...
  const RenderFilter = () =>{
    ...
    return(
      ...
      <div className="select">
        ...
        <div className="add-new-invoice row align-items-center" onClick = {ToggleEddNewInvoice}>
              ...
              <form onSubmit = {handleSubmit}>
                ...
                <div className="list-items">
                  ...
                  <div className="btn-control-edit">
                   <button className="btn cancel-btn" type="button" onClick={toggleDisplayAdd}>Cancel</button>
